...
/* ---- 다섯 묶음 ---- */
const M2_BUNDLES = [
  {k:1, title:'안녕하세요', topic:'인사하고 이름 말하기', nights:[1, 2, 3]},
  {k:2, title:'우리 가족', topic:'가족을 부르는 말, 있어요와 없어요', nights:[4, 5, 6]},
